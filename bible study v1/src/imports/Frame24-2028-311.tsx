import svgPaths from "./svg-vlibl4tule";
...
function BackgroundImage5({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="flex flex-col justify-end size-full">
      <div className="content-stretch flex flex-col items-start justify-end px-[32px] py-[28px] relative size-full">{children}</div>
    </div>
  );
}
...
function VectorBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="absolute inset-[29.16%_29.17%_29.17%_29.16%]">
...
function ContainerBackgroundImage2() {
  return (
    <div className="content-stretch flex flex-col items-start pb-0 pt-[14.4px] px-[14.4px] relative rounded-[1.00663e+07px] shrink-0 size-[48px]">
      <div aria-hidden="true" className="absolute border-[1.2px] border-solid border-white inset-0 pointer-events-none rounded-[1.00663e+07px]" />
...
function IconBackgroundImage3() {
  return (
    <div className="h-[19.2px] overflow-clip relative shrink-0 w-full">
      <VectorBackgroundImage>
        <path d="M0.8 0.8H8.8V8.8" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" />
      </VectorBackgroundImage>
      <VectorBackgroundImage>
        <path d="M0.8 8.8L8.8 0.8" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" />
      </VectorBackgroundImage>
    </div>
  );
}
...
function BackgroundImage({ text, text1 }: BackgroundImageProps) {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px not-italic relative shrink-0 text-white">
...
function Nav() {
  return (
    <div className="absolute content-stretch flex gap-[160px] items-start justify-center left-[calc(50%+0.5px)] top-[32px] translate-x-[-50%]" data-name="nav">
      <LaubfLogo />
      <Container />
      <Container1 />
    </div>
...
function Icon() {
  return (
    <BackgroundImage1>
      <path d="M5 12H19" id="Vector" stroke="var(--stroke-0, #0D0D0D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
      <path d="M12 5L19 12L12 19" id="Vector_2" stroke="var(--stroke-0, #0D0D0D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
    </BackgroundImage1>
  );
}
...
function Link2() {
  return (
    <div className="bg-white content-stretch flex gap-[9px] items-center px-[48px] py-[22px] relative rounded-[1.67772e+07px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.2),0px_8px_10px_-6px_rgba(0,0,0,0.2)] shrink-0" data-name="Link">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[28px] not-italic relative shrink-0 text-[#0d0d0d] text-[20px] text-center text-nowrap tracking-[-0.4492px]">{`I'm New`}</p>
      <Icon />
    </div>
  );
}
...
function Link3() {
  return (
    <div className="content-stretch flex items-center px-[40px] py-[22px] relative rounded-[1.67772e+07px] shrink-0" data-name="Link">
      <div aria-hidden="true" className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[1.67772e+07px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.2),0px_8px_10px_-6px_rgba(0,0,0,0.2)]" />
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[28px] not-italic relative shrink-0 text-[20px] text-center text-nowrap text-white tracking-[-0.4492px]">About Us</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start not-italic relative shrink-0 w-[960px]">
      <p className="font-['Helvetica_Neue:Medium',sans-serif] leading-none min-w-full relative shrink-0 text-[48px] text-black tracking-[-1.44px] w-[min-content]">Upcoming Events</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#313131] text-[20px] text-nowrap tracking-[-0.6px]">Come as you are and join us as we gather to grow in faith and community.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex items-end justify-between px-[20px] py-0 relative w-full">
          <Frame10 />
          <Link4 />
        </div>
      </div>
...
function Icon2() {
  return (
    <IconBackgroundImage4 additionalClassNames="left-0 top-[2px]">
...
function Events() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Events">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center p-[120px] relative w-full">
          <UpcomingEvents />
        </div>
      </div>
    </div>
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start not-italic relative shrink-0 w-[320px]">
      <div className="font-['Helvetica_Neue:Medium',sans-serif] leading-[1.1] relative shrink-0 text-[48px] text-black tracking-[-1.44px] w-full">
        <p className="mb-0">Your</p>
        <p className="mb-0">{`Next Steps `}</p>
        <p>at LA UBF</p>
      </div>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#313131] text-[20px] tracking-[-0.6px] w-full">Explore different ways to connect, grow in faith, and be part of our community.</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="content-stretch flex gap-[16px] items-end relative shrink-0 w-full">
      <BackgroundImage text="Personal Bible Studies" text1="Study the Bible and grow deeper in God’s Word." />
      <ContainerBackgroundImage2 />
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="content-stretch flex gap-[16px] items-end relative shrink-0 w-full">
      <BackgroundImage text="Fellowship" text1="Build meaningful friendships and walk life together in faith." />
      <ContainerBackgroundImage2 />
    </div>
  );
}
...
function WhatwedoCard2() {
  return (
    <div className="[grid-area:2_/_2] place-self-stretch relative rounded-[16px] shrink-0" data-name="whatwedo-card">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[16px]">
        <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[16px] size-full" src={imgWhatwedoCard2} />
        <div className="absolute bg-gradient-to-b from-[43.75%] from-[rgba(0,0,0,0)] inset-0 rounded-[16px] to-[68.75%] to-[rgba(0,0,0,0.71)]" />
      </div>
      <BackgroundImage5>
        <Frame17 />
...
function Frame18() {
  return (
    <div className="content-stretch flex gap-[16px] items-end relative shrink-0 w-full">
      <BackgroundImage text="College Campus Ministries" text1="Connect with a Christ-centered community right on your campus." />
      <ContainerBackgroundImage2 />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="basis-0 gap-[20px] grid grid-cols-[repeat(2,_minmax(0px,_1fr))] grid-rows-[repeat(2,_minmax(0px,_1fr))] grow h-[760px] min-h-px min-w-px relative shrink-0">
      <WhatwedoCard />
      <WhatwedoCard1 />
      <WhatwedoCard2 />
      <WhatwedoCard3 />
...
function WhatWeDo() {
  return (
    <div className="content-stretch flex gap-[40px] items-start justify-center relative shrink-0 w-full" data-name="WhatWeDo">
      <Frame15 />
      <Frame4 />
    </div>
  );
...
function WhatWeDo1() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center p-[120px] relative shrink-0 w-[1440px]" data-name="WhatWeDo">
      <WhatWeDo />
    </div>
  );
}
...
function Container19() {
  return (
    <div className="relative rounded-[1.67772e+07px] shrink-0 size-[64px]" data-name="Container">
      <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[1.67772e+07px] size-full" src={imgContainer2} />
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="relative shrink-0">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[12px] items-start not-italic relative text-nowrap">
        <p className="font-['Helvetica_Neue:Medium',sans-serif] leading-none relative shrink-0 text-[48px] text-black tracking-[-1.44px]">What we’re up to</p>
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#313131] text-[20px] text-center tracking-[-0.6px]">@la.ubf</p>
      </div>
    </div>
  );
}
...
function InstagramPost() {
  return (
    <div className="aspect-[270/270] basis-0 grow min-h-px min-w-px relative rounded-[16px] shrink-0" data-name="Instagram Post">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[16px] size-full" src={imgInstagramPost} />
    </div>
  );
}
...
function InstagramPost1() {
  return (
    <div className="aspect-[270/270] basis-0 grow min-h-px min-w-px relative rounded-[16px] shrink-0" data-name="Instagram Post">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[16px] size-full" src={imgInstagramPost1} />
    </div>
  );
}

function InstagramPost2() {
  return (
    <div className="aspect-[270/270] basis-0 grow min-h-px min-w-px relative rounded-[16px] shrink-0" data-name="Instagram Post">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[16px] size-full" src={imgInstagramPost2} />
    </div>
  );
}

function InstagramPost3() {
  return (
    <div className="aspect-[270/270] basis-0 grow min-h-px min-w-px relative rounded-[16px] shrink-0" data-name="Instagram Post">
      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[16px] size-full" src={imgInstagramPost3} />
    </div>
  );
}
...
function Instagram() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Instagram">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[40px] items-center p-[120px] relative w-full">
          <Container21 />
          <Frame13 />
        </div>
      </div>
...
function Icon5() {
  return (
    <IconBackgroundImage4 additionalClassNames="left-[115.97px] top-[17px]">
