...
const heroData: MinistryHeroSectionProps = {
  ...
  content: {
    ...
    ctaButton: {
      ...
      href: "https://startbiblestudy.org/ucla",
      visible: true,
    },
    socialLinks: [
...
const faqData: FAQSectionProps = {
  ...
  content: {
    ...
    items: [
      ...
      {
        question: "Is this only for UCLA students?",
        answer:
          "While our group is based at UCLA, anyone is welcome to join. You don't have to be a current student to attend.",
      },
      {
