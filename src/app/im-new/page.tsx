...
const campusCardGridData: CampusCardGridSectionProps = {
  ...
  content: {
    ...
    campuses: [
      { id: "lbcc", abbreviation: "LBCC", fullName: "Long Beach City College" },
