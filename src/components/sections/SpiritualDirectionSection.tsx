 ...
 *
 * DB SCHEMA: spiritual_directions (id, year, overline, heading, verse_text,
...
export default function SpiritualDirectionSection(props: {
  settings: SpiritualDirectionSectionProps;
}) {
