 ...
 *
 * DB SCHEMA: next_steps_sections (id, heading_line1, heading_line2, heading_line3,
 *   subheading, visible)
 *   + next_step_cards (id, section_id, title, description, image_url, href, position)
 */
"use client";
...
export default function NextStepsSection(props: {
  settings: NextStepsSectionProps;
}) {
