      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center justify-between">
            ...
            {/* View toggle */}
            <div className="hidden lg:flex items-center gap-1 rounded-[14px] bg-white-2 p-1">
              <button className="flex items-center gap-2 rounded-[10px] border-[0.5px] border-white-2 bg-white-1 px-4 py-3 text-button-1 text-black-1 shadow-[0px_1px_3px_rgba(0,0,0,0.1),0px_1px_2px_rgba(0,0,0,0.1)]">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path d="M2 4h12M2 8h12M2 12h12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
                List
              </button>
              <button className="flex items-center gap-2 rounded-[10px] px-4 py-3 text-button-1 text-black-3">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
