...
export interface BibleStudy {
  ...
  hasQuestions?: boolean; // Indicates if study has questions
  hasAnswers?: boolean; // Indicates if study has answers/guide
  hasTranscript?: boolean; // Indicates if study has message transcript
  attachments?: {
    name: string;
    url: string;
...
<p>Well, in this passage Jesus comes and meets them in Galilee, at the sea of Tiberias, which is the sea of Galilee. They had gone there because Jesus told them he would meet the in Galilee after he had risen. So they did a good thing by going to Galilee. But they really didn't know what to do.</p>
