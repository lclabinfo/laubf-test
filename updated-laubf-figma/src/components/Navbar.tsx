...
type PageType = 
  | 'home' | 'about' | 'events' | 'event-detail' | 'sermons' | 'sermon-detail' 
  | 'daily-bread' | 'videos' | 'im-new' | 'campuses' | 'campus-detail' 
  | 'bbf-cbf' | 'studies' | 'study-detail' | 'login' | 'member-hub'
  // New pages
  | 'history' | 'visit' | 'meetings' | 'programs' | 'photos' | 'yam-college' | 'jbf' | 'hbf' | 'adults' | 'give' | 'ministries'
  | 'prayer-topics' | 'announcements' | 'account-settings' | 'announcement-detail' | 'chat';
...
export default function Navbar({ onNavigate, currentPage = 'home', isLoggedIn = false, variant = 'default', onLogout }: NavbarProps) {
  ...
  return (
    <nav className={`${navClasses} z-50 transition-all duration-300 cursor-auto`}>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col gap-1">
                             ...
                             >
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">Who We Are</div>
                                    <div className="text-xs text-gray-500 font-medium">Our mission & vision</div>
                                </div>
                             </a>
                             <a 
                               href="#im-new"
                             ...
                             >
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">I'm New</div>
                                    <div className="text-xs text-gray-500 font-medium">Plan your visit</div>
                                </div>
                             </a>
                             <a 
                             ...
                             >
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-gray-500 font-medium">Watch live services</div>
                                </div>
                             </a>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col gap-1">
                             ...
                             >
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">Announcements</div>
                                    <div className="text-xs text-gray-500 font-medium">Church news</div>
                                </div>
                             </a>
                             <a 
                               href="#prayer-topics"
                             ...
                             >
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">Prayer Topics</div>
                                    <div className="text-xs text-gray-500 font-medium">Share requests</div>
                                </div>
                             </a>
                        </div>
                    </div>
                ...
                <div className="absolute top-[80%] left-1/2 -translate-x-1/2 pt-4 z-50">
                  <div className="w-[850px] bg-white rounded-3xl shadow-2xl border border-gray-100 p-0 overflow-hidden flex animate-in fade-in zoom-in-95 duration-200">
                    ...
                    <div className="w-[280px] bg-gray-50 p-6 flex flex-col gap-6 border-r border-gray-100">
                        <div>
                            <div className="text-xs font-black text-gray-400 uppercase tracking-widest mb-4">Ministry Groups</div>
                            <div className="space-y-2">
                                <a href="#yam-college" onClick={(e) => handleNavClick(e, 'yam-college')} className="group block">
                                    <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-white hover:shadow-sm transition-all">
                                        ...
                                        <div className="text-sm font-bold text-gray-700 group-hover:text-[#3667B1]">College & YAM</div>
                                    </div>
                                </a>
                                <a href="#adults" onClick={(e) => handleNavClick(e, 'adults')} className="group block">
                                    <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-white hover:shadow-sm transition-all">
                                        <div className="w-8 h-8 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center">
                                            <Users className="w-4 h-4" />
                                        </div>
                                        <div className="text-sm font-bold text-gray-700 group-hover:text-[#3667B1]">Adults</div>
                                    </div>
                                </a>
                                <a href="#hbf" onClick={(e) => handleNavClick(e, 'hbf')} className="group block">
                                    <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-white hover:shadow-sm transition-all">
                                        <div className="w-8 h-8 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center">
                                            <Music className="w-4 h-4" />
                                        </div>
                                        <div className="text-sm font-bold text-gray-700 group-hover:text-[#3667B1]">High School (HBF)</div>
                                    </div>
                                </a>
                                <a href="#jbf" onClick={(e) => handleNavClick(e, 'jbf')} className="group block">
                                    <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-white hover:shadow-sm transition-all">
                                        <div className="w-8 h-8 rounded-full bg-green-100 text-green-600 flex items-center justify-center">
                                            <Heart className="w-4 h-4" />
                                        </div>
                                        <div className="text-sm font-bold text-gray-700 group-hover:text-[#3667B1]">Junior High (JBF)</div>
                                    </div>
                                </a>
                                <a href="#bbf-cbf" onClick={(e) => handleNavClick(e, 'bbf-cbf')} className="group block">
                                    <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-white hover:shadow-sm transition-all">
                                        <div className="w-8 h-8 rounded-full bg-yellow-100 text-yellow-600 flex items-center justify-center">
                                            <Baby className="w-4 h-4" />
                                        </div>
                                        <div className="text-sm font-bold text-gray-700 group-hover:text-[#3667B1]">Children (BBF/CBF)</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="mt-auto bg-[#3667B1] rounded-xl p-4 text-white relative overflow-hidden group cursor-pointer" onClick={(e) => handleNavClick(e as any, 'ministries')}>
                            <div className="relative z-10">
                                <div className="font-bold text-sm mb-1">Ministries Overview</div>
                                <div className="text-xs text-white/80 mb-3">See all our community groups.</div>
                                <div className="text-[10px] font-bold uppercase tracking-widest flex items-center gap-1">View Hub <ChevronDown className="w-3 h-3 -rotate-90" /></div>
                            </div>
                    ...
                    <div className="flex-1 p-8">
                        <div className="flex items-center justify-between mb-6">
                            <div className="text-xs font-black text-gray-400 uppercase tracking-widest">College Ministries</div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                            {campuses.map((campus) => (
                              <a 
                                key={campus.id}
                                href={`#${campus.slug}`}
                                onClick={(e) => handleNavClick(e, 'campus-detail', campus.id)}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col gap-1">
                             ...
                             >
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">Sunday Messages</div>
                                    <div className="text-xs text-gray-500 font-medium">Weekly sermons</div>
                                </div>
                             </a>
                             <a 
                               href="#studies"
                             ...
                             >
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">Bible Studies</div>
                                    <div className="text-xs text-gray-500 font-medium">Study guides & notes</div>
                                </div>
                             </a>
                             <a 
                               href="#daily-bread"
                             ...
                             >
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">Daily Bread</div>
                                    <div className="text-xs text-gray-500 font-medium">Daily devotionals</div>
                                </div>
                             </a>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col gap-1">
                             ...
                             >
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-gray-500 font-medium">Recaps & specials</div>
                                </div>
                             </a>
                             <a 
                               href="#photos"
                             ...
                             >
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-gray-500 font-medium">Gallery</div>
                                </div>
                             </a>
                        </div>
                    </div>
          ...
          <div className="flex items-center gap-4">
                        ...
                        <div className="absolute top-[120%] right-0 w-56 animate-in fade-in zoom-in-95 duration-200 z-50">
                            <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-2 overflow-hidden">
                                <div className="px-3 py-2 border-b border-gray-100 mb-1">
                                    ...
                                    <p className="text-sm font-bold text-gray-900 truncate">john.doe@example.com</p>
                                </div>
                                <button 
                                    onClick={() => { onNavigate?.('account-settings'); setActiveDropdown(null); }}
                                ...
                                <button 
                                    onClick={() => { onLogout?.(); setActiveDropdown(null); }}
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              <SheetTrigger asChild>
                <Button variant="ghost" size="icon" className={`lg:hidden ${isTransparent ? 'text-white hover:bg-white/20' : 'text-gray-900'}`}>
              ...
              <SheetContent className="w-full sm:max-w-sm p-0 flex flex-col bg-white overflow-hidden">
                <SheetHeader className="px-6 py-4 border-b border-gray-100 flex flex-row items-center justify-between text-left space-y-0">
                    <SheetTitle className="text-[#3667B1] font-black text-2xl tracking-tighter">LA UBF</SheetTitle>
                ...
                <div className="flex-1 overflow-y-auto px-6 py-6">
                    <nav className="flex flex-col gap-6">
                       ...
                       <div className="space-y-3">
                           <div className="text-xs font-black text-gray-400 uppercase tracking-widest">Our Church</div>
                           <div className="flex flex-col gap-3 pl-2 border-l-2 border-gray-100">
                               <a href="#about" onClick={(e) => handleNavClick(e, 'about')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">About Us</a>
                               <a href="#events" onClick={(e) => handleNavClick(e, 'events')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">Calendar</a>
                               <a href="#history" onClick={(e) => handleNavClick(e, 'history')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">History</a>
                               <a href="#visit" onClick={(e) => handleNavClick(e, 'im-new')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">Visit Us</a>
                           </div>
                       </div>

                       {/* Ministries Section */}
                       <div className="space-y-3">
                           <div className="text-xs font-black text-gray-400 uppercase tracking-widest">Ministries</div>
                           <div className="flex flex-col gap-3 pl-2 border-l-2 border-gray-100">
                               <a href="#campuses" onClick={(e) => handleNavClick(e, 'campuses')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">All Campuses</a>
                               <a href="#yam-college" onClick={(e) => handleNavClick(e, 'yam-college')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">College & YAM</a>
                               <a href="#hbf" onClick={(e) => handleNavClick(e, 'hbf')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">High School</a>
                               <a href="#jbf" onClick={(e) => handleNavClick(e, 'jbf')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">Junior High</a>
                               <a href="#bbf-cbf" onClick={(e) => handleNavClick(e, 'bbf-cbf')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">Kids</a>
                           </div>
                       </div>

                       {/* Resources Section */}
                       <div className="space-y-3">
                           <div className="text-xs font-black text-gray-400 uppercase tracking-widest">Resources</div>
                           <div className="flex flex-col gap-3 pl-2 border-l-2 border-gray-100">
                               <a href="#sermons" onClick={(e) => handleNavClick(e, 'sermons')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">Sermons</a>
                               <a href="#studies" onClick={(e) => handleNavClick(e, 'studies')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">Bible Studies</a>
                               <a href="#videos" onClick={(e) => handleNavClick(e, 'videos')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1]">Videos</a>
                           </div>
                       </div>

                       <div className="pt-4 border-t border-gray-100">
                           <a href="#give" onClick={(e) => handleNavClick(e, 'give')} className="text-lg font-bold text-gray-900 hover:text-[#3667B1] flex items-center gap-2">
