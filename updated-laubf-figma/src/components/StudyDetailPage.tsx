      ...
      <div className="max-w-[1600px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            <div className="lg:col-span-8 flex flex-col gap-6">
                ...
                {study.videoId || hasTranscript ? (
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-[700px] lg:h-[900px]">
                        
                        {/* VIDEO PLAYER */}
                        {study.videoId && (
                            <div className="relative bg-black rounded-[24px] overflow-hidden shadow-sm h-[400px] lg:h-full">
                                <iframe 
                                    width="100%" 
                                    height="100%" 
                                    src={`https://www.youtube.com/embed/${study.videoId}?rel=0`} 
                                    title={study.title} 
                                    frameBorder="0" 
                        ...
                        {/* TRANSCRIPT TABS */}
                        {hasTranscript && (
                            <div className="flex-1 bg-white rounded-[24px] border border-[#e8e8e8] flex flex-col overflow-hidden shadow-sm lg:h-full">
                                <Tabs value="transcript" className="flex flex-col h-full">
                                    <div className="px-6 py-4 border-b border-[#f0f0f0] flex items-center justify-between shrink-0 bg-white z-10">
                                        <TabsList className="flex gap-6 overflow-x-auto no-scrollbar bg-transparent p-0">
                                            <TabsTrigger value="transcript" className="data-[state=active]:text-[#0d0d0d] data-[state=active]:border-b-2 data-[state=active]:border-[#0d0d0d] text-[#9ca3af] text-[11px] font-bold uppercase tracking-widest py-2 rounded-none border-b-2 border-transparent transition-all whitespace-nowrap bg-transparent shadow-none hover:bg-transparent">
                                                Message Transcript
                                            </TabsTrigger>
                                        </TabsList>
                                    </div>
                                                ...
                                                {linkedSermon ? (
                                                    <>
                                                        <div className="mb-8 border-b border-[#f0f0f0] pb-6">
                                                            <h2 className="text-[20px] font-medium tracking-tight text-[#0d0d0d] mb-1">{linkedSermon.title}</h2>
                                                            <p className="text-[13px] text-[#6b7280]">Message by {linkedSermon.speaker}</p>
                                                        </div>
                                                        <div 
                                                          className="prose prose-base max-w-none prose-p:text-[#4b5563] prose-p:leading-[1.7] font-['Georgia',_serif]"
                ...
                {/* INTERACTIVE STUDY CONTENT (Scripture & Questions) */}
                <div className="flex-1 bg-white rounded-[24px] border border-[#e8e8e8] flex flex-col overflow-hidden shadow-sm min-h-[600px]">
